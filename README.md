...
2. [💻 Interactive Shell Mode](#interactive-shell-mode)  
   ...
   3. [📜 Command History](#command-history)  
      1. [In-Memory History](#in-memory-history)  
      2. [Persistent History File](#persistent-history-file)  
      3. [The `history` Builtin](#the-history-builtin)  
   4. [🔁 Tab Completion](#tab-completion)  
      1. [Completion Types](#completion-types)  
      2. [Completion Behavior](#completion-behavior)  
